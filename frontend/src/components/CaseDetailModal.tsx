...
import { EmergencyCase, severityConfig, getRequiredServicesForCase, type Hospital } from "@/data/api";
import { X, MapPin, Clock, User, Stethoscope, Brain, Wind, Bone, Heart, Gauge, Hash, Ambulance, Building2, Phone, Users, Bed } from "lucide-react";
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-background/80 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <div className="p-4 space-y-0">
          ...
          {caseData.victimName && <DetailRow icon={User} label="Victim Name" value={caseData.victimName} />}
          ...
          {assignedHospital && (
            <div className="mt-3 pt-3 border-t border-border">
              <span className="text-[10px] uppercase tracking-wider text-primary font-semibold block mb-2">Nearest hospital with capacity &amp; services</span>
